...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicWFtYXJhYmJhc3giLCJhIjoiY2w0ejhsd3g3Mjc3NDNkbWxzbnM2eTd0MCJ9.EyEGvjas2z0Axh7cVGgtWA';
...
var updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(currPass, newPass, ConfirmPass) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
...
var stripe = Stripe('pk_test_51LHCFLDxuxUBQHNrrpqttprQ1PwBdYZmXxNOrD5ky9NKJmji6O4US01BqmKjp27TUVfhgOmkDKYoYnnjG9W1Bafn00DgWaE4Qo');
...
if (bookTourBtn) {
  bookTourBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing ...'; // we defined dataset on this button as data-tour-id , we read this in js as dataset.tourId
